            ...
            public void actionPerformed(ActionEvent e)
            {
                if(e.getSource()==bt1)
                {
                    ...
                    try{
                        ...
                        String qo="select quantity from addbook where id='"+id+"'";
                        ResultSet rest0=obj3.stn.executeQuery(qo);
                        while(rest0.next())
                        {
                        ...
                        {
                           String q2="insert into issuebook(BookId,bookname,studentId,studentname,studentcontact,date) values('"+id+"','"+bookno+"','"+bookname+"','"+stuid+"','"+stuname+"','"+stucont+"','"+date+"')";
                           ...
                           if(aa==1)
                           {
                              if(aaa==1){
                                  if(aaaa==1)
                                  {
                                      JOptionPane.showMessageDialog(null,"your data successsfully updates");
                                      this.setVisible(false);
                                  }
                                  else
                                          {
                                              JOptionPane.showMessageDialog(null,"please!,fill data all detail carefully");
